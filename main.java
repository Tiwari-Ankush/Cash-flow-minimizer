        ...
        try {
            ...
            for (int i = 0; i < numBanks; i++) {
                ...
                for (int j = 0; j < numTypes; j++) {
                    System.out.print("Payment mode " + (j + 1) + ": ");
            ...
            for (int i = 0; i < numTransactions; i++) {
                System.out.print("Transaction " + (i + 1) + " - From Bank: ");
                String from = scanner.nextLine();
                System.out.print("To Bank: ");
            ...
            System.out.println("Invalid input format. Please enter the correct data.");
        } finally {
            scanner.close();
        }
    }
